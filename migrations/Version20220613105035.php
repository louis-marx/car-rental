 ...
 */
final class Version20220613105035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrat (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, voiture_id INT NOT NULL, date_depart DATETIME NOT NULL, date_retour DATETIME NOT NULL, INDEX IDX_6034999319EB6921 (client_id), INDEX IDX_60349993181A8BA (voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
